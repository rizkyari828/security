                ...
                child: Column(
                  children: [
                    ...
                    DetailInfoRow(
                      ...
                      label: 'Tanggal mulai',
                      value: detail.tanggalAwal == null
                          ? '-'
                          : dateFormat.format(detail.tanggalAwal!),
                    ),
                    const SizedBox(height: 12),
                    DetailInfoRow(
                      icon: Icons.event_outlined,
                      label: 'Tanggal selesai',
                      value: detail.tanggalAkhir == null
                          ? '-'
                          : dateFormat.format(detail.tanggalAkhir!),
                    ),
                  ],
                ),
              ),
              const SizedBox(height: 12),
              const DetailSectionTitle(title: 'Keperluan'),
              const SizedBox(height: 8),
              DetailSectionCard(
                child: Text(
